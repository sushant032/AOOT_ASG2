...
<head>
  ...
  <title>Webstore Shop - Cart</title>
  ...
  <!--================ Start Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.jsp">Web Store</a>
                              ...
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          ...
                                          <img src="img/product/<%out.print(p.img);%>" alt="">
                                      </div>
                                      <div class="media-body">
                                          <p><%out.print(p.name);%></p>
                                      </div>
                                  </div>
                              </td>
                              <td>
                                  <h5>$<%out.print(p.price);%></h5>
                              </td>
                              <%-- <td>
                          ...
                          <tr class="out_button_area">
                              ...
                              <td>
                                  <div class="checkout_btn_inner d-flex align-items-center">
                                      <%-- <a class="gray_btn ml-2" href="index.jsp">Continue Shopping</a> --%>
