                        ...
                        <ul class="list">
                            ...
                            <%
                              for(Product p: c.products){
                                total+=p.price;
                            %>
                            <li><a href="#"><%out.print(p.name);%> <span class="last">$<%out.print(p.price);%></span></a></li>
                            <%
                              }
                            %>
                        </ul>
                        <ul class="list list_2">
                            <li><a href="#">Subtotal <span>$<%out.print((total));%></span></a></li>
                            <li><a href="#">Shipping <span>Flat rate: $50.00</span></a></li>
                            <li><a href="#">Total <span>$<%out.print((total + 50));%></span></a></li>
                        </ul>
