...
<%@ page import="webstore.cart" %>


<%
Class.forName("com.mysql.jdbc.Driver");
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/web_store","root", "");
Statement st=conn.createStatement();
cart c = (cart) application.getAttribute("CART");
if(c!=null)
    application.setAttribute("CART", new cart(c));
else
    application.setAttribute("CART", new cart());
...
<head>
  ...
  <title>Web Store Shop - Home</title>
  ...
  <!--================ Start Header Menu Area =================-->
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="index.jsp"><h3>Web Store</h3></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav-shop">
              ...
              <li class="nav-item"><button><a href="cart.jsp"><i class="ti-shopping-cart"></i><span class="nav-shop__circle"><% out.print(c.products.size());%></span></a></button> </li>
    ...
    <section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          ...
          <h2>Trending <span class="section-intro__style"><% out.println(rs.getString("name"));%></span></h2>
        </div>
        <div class="row">

          <%

              // String query = "select * from products where id = " + rs.getInt("id");
              // ResultSet items = st.executeQuery(query);
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
              <div class="card text-center card-product">
                <div class="card-product__img">
                  <img class="card-img" src="img/product/<% out.print(items.getString("image"));%>" alt="">
                  <ul class="card-product__imgOverlay">
                    <li><button><i class="ti-search"></i></button></li>
                    <li><button><a href="addtocart?product_id=<%out.print(items.getString("id"));%>"><i class="ti-shopping-cart"></i></button></a></li>
                    <li><button><i class="ti-heart"></i></button></li>
                  </ul>
                </div>
                <div class="card-body">
                  <p><% out.println(rs.getString("name"));%></p>
                  <h4 class="card-product__title"><a href="single-product.jsp"><% out.println(items.getString("name"));%></a></h4>
                  <p class="card-product__price"><% out.println(items.getString("cost"));%></p>
                </div>
              </div>
            </div>
          <%
